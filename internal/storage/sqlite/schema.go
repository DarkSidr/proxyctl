...
var schemaMigrations = []string{
	...
	`ALTER TABLE inbounds ADD COLUMN sniffing_enabled INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE inbounds ADD COLUMN sniffing_http INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE inbounds ADD COLUMN sniffing_tls INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE inbounds ADD COLUMN sniffing_quic INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE inbounds ADD COLUMN sniffing_fakedns INTEGER NOT NULL DEFAULT 0`,
	...
	`ALTER TABLE subscriptions ADD COLUMN label TEXT NOT NULL DEFAULT ''`,
}
